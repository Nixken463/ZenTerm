...
ls_parser = argparse.ArgumentParser(
    description="List directory contents", parents=[force_parser]
)
...
ls_parser.add_argument(
    "-l", "--long", action="store_true", help="List files in long format"
)
ls_parser.add_argument(
    "-r", "--reverse", action="store_true", help="List in reverse order"
)
